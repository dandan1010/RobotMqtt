...
public final class Content {
    ...
    */
    ...
    public static final String START_MOVE = "startMove";//操纵机器人移动
    ...
    public static final String INITIALIZE = "initialize";//机器人初始化
    ...
    public static final String ADDPOINTPOSITION = "addPointPosition";
    ...
    public static final String CONN_OTHER = "other_connected";
    ...
    public static final String Temp = "temp";//临时地图
    public static final String Current = "current";//应用地图
    ...
    public static final String ROBOT_IS_CHARGING = "Charging at ";

    public static final String TEMP_TASK_NAME = "Temp";
    public static final String TEMP_TASK_TIME = "FF:FF";
    public static final String dbAlarmIsRun = "dbAlarmIsRun";//task is today
    ...
    public static final String DOWNLOAD_MAP = "download_map";//下载地图
